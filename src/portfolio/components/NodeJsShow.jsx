...
export const NodeJsShow = () => {
    return (
        <Grid container sx={{ height: '50vh', backgroundImage: 'url("https://res.cloudinary.com/djvtfyvmr/image/upload/v1664927710/journal/ioieqqea7ceuhkug8rlk.png")' }}>
            <List>
                <ListItem>
                    <ListItemIcon>
