...
export const ReactNativeShow = () => {
    return (
        <Grid container sx={{ height: '50vh', backgroundImage: 'url("https://res.cloudinary.com/djvtfyvmr/image/upload/v1664928150/journal/cbe6nzldlswkxjp3dpn2.png")' }}>
            <List>
                <ListItem>
                    <ListItemIcon>
