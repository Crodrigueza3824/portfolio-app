...
export const PostManShow = () => {
    return (
        <Grid container sx={{ height: '50vh', backgroundImage: 'url("https://res.cloudinary.com/djvtfyvmr/image/upload/v1664927743/journal/ouykvvt7nmakl5pkvguu.png")' }}>
            <List>
                <ListItem>
                    <ListItemIcon>
