...
export const MongoDbShow = () => {
    return (
        <Grid container sx={{ height: '50vh', backgroundImage: 'url("https://res.cloudinary.com/djvtfyvmr/image/upload/v1664927734/journal/a28pam0wc0r7k9u5hbi5.png")' }}>
            <List>
                <ListItem>
                    <ListItemIcon>
